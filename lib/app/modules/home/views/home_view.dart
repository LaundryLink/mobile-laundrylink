              ...
              child: Column(
                children: [
                          ...
                          Container(
                            ...
                            child: Wrap(
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      controller.fetchOutlets();
                                    Get.toNamed(Routes.LISTOUTLET, arguments: controller.outletsList2);
                                    },
                                    child: Text(
                                      "Lihat Semua",
                                      style: TextStyle(
                  ...
                  Obx(() {
                    if (controller.isLoading.value) {
                    ...
                    } else if (controller.outletsList2.isEmpty) {
                      return Center(
                      ...
                      return Container(
                          ...
                          child: ListView.builder(
                            ...
                            itemCount: controller.outletsList2.length,
                            itemBuilder: (context, index) {
                              final outlet = controller.outletsList2[index];
                              return CardOutlet(
                                outlet: outlet,
                                marginLeft: 25,
                                marginBottom: 10,
                    ...
                    if (controller.isLoading.value) {
                      ...
                      return Container(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              print("ini outlet2" +
                                  controller.outletsList2[index].toString());
                              final outlet = controller.outletsList2[index];
                              return CardOutlet(
                                  outlet: outlet,
                                  marginLeft: 25,
